...
import 'package:pears/blocs/bloc/Bloc.dart';
...
import 'package:pears/config/Styles.dart';
import 'package:pears/config/Transitions.dart';
import 'package:pears/pages/ConversationPageSlide.dart';
import 'package:pears/widgets/CircleIndicator.dart';
import 'package:pears/widgets/NumberPicker.dart';
...
class _RegisterPageState extends State<RegisterPage>
  ...
  late Animation profilePicHeightAnimation, usernameAnimation, ageAnimation;
  ...
  Future getImage() async {
    ...
    // PickedFile? profileImageFile = await picker.getImage(source: ImageSource.gallery);
    // imageFile = File(profileImageFile);
    // authenticationBloc.add(PickedProfilePicture(profileImageFile));
    profileImageFile = File(await ImagePicker()
